...
//	url = "downloadFiles/50kb.txt";
//	div = 50;
	
//	url = "downloadFiles/500kb.txt";
//	div = 500;

	url = "http://speedtracks.org/speedtrack-webclient/downloadFiles/100kb.txt";
//	div = 100;
	
//	url = "downloadFiles/250kb.txt";
//	div = 250;
	
//	url = "downloadFiles/2mb.txt";
//	div = 2000;
	
//	url = "downloadFiles/1000kb.txt";
//	div = 1000;
...
//	latency = ((latencyTimeSum / 10) / 2) / 1000.0; 		//sec
	latency = ((latencyTimeSum / 10) / 2); 					//milli sec
...
//	time = ((downloadTimeSum)); 						//milli sec
	if (time != 0){											
		downloadRate = ((700/time)*1000);					// in Byte pro sec da es so auf HP steht
...
//	   data = data + div;
		...
		if(i > 3){
			url = "http://speedtracks.org/speedtrack-webclient/downloadFiles/50kb.txt";
			// div = 150;
		}
...
//				alert("Fehler mit dem runterlaen der datei" + jqXHR + textStatus + errorThrown);
//				alert("jqXHR: " + jqXHR);
